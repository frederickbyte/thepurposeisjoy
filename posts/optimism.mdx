...
summary: Life is about happiness
tags: 'philosophy'
typeId: '1'
---
...
<CalloutWithLabel title="Foundational Principles">
...
<span style={{background: '#FFDD55', padding: '0.15em .25rem', borderRadius:' 0.25rem'}}>The goal of life is to be happy.</span> Despite what politicians, the Pope, or intellectuals may say, you *are* capable of flourishing in this world.
