...
<span className="py-[0.15em] px-1 rounded bg-golden">Life can be better.</span> But evil ideas are handicapping your life and the lives of those you care about.
...
<span className='py-[0.15em] px-1 rounded bg-golden'>The goal of life is to be happy.</span> Despite what politicians, the Pope, and intellectuals may say, you *are* capable offlourishing in this world.
